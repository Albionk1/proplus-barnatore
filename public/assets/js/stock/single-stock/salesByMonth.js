...
var SalesByMonth = {
       ...
       if ('undefined' != typeof am5) {
         ...
         if (e) {
           ...
           am5.ready(function () {
               ...
               showLoadingSpinner()
               fetch('/api/v1/article/get-article-sells-by-month', {
                method: 'POST',
                body: JSON.stringify({ article: location.pathname.split('/')[3],year:$("#sales-by-month-select").val() }),
 ...
 const yearSelectOutcome = $("#sales-by-month-select");
 ...
 $("#select-product").on("change", function() {
  location.assign('/admin/stock-product/'+$("#select-product").val())
 })
