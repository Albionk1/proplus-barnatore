...
var listingOut = (function () {
    var e,
        ...
        c = () => {
            e.querySelectorAll('[data-kt-ecommerce-order-filter1="delete_row"]').forEach((e) => {
                e.addEventListener("click", function (e) {
                    e.preventDefault();
                    const n = e.target.closest("tr"),
                        r = n.querySelector('[data-kt-ecommerce-order-filter1="order_id"]').innerText;
                    Swal.fire({
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_ecommerce_sales_table1")) &&
                ((t = $(e).DataTable({
                    info: !1,
                    order: [],
                    pageLength: 10,
                ...
                document.querySelector('[data-kt-ecommerce-order-filter1="search"]').addEventListener("keyup", function (e) {
                    t.search(e.target.value).draw();
                }),
                (() => {
                    const e = document.querySelector('[data-kt-ecommerce-order-filter1="status"]');
                    $(e).on("change", (e) => {
