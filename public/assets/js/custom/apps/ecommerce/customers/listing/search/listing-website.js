...
var listingWebsite = (function () {
    var e,
        ...
        c = () => {
            e.querySelectorAll('[data-kt-ecommerce-order-filter7="delete_row"]').forEach((e) => {
                e.addEventListener("click", function (e) {
                    e.preventDefault();
                    const n = e.target.closest("tr"),
                        r = n.querySelector('[data-kt-ecommerce-order-filter7="order_id"]').innerText;
                    Swal.fire({
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_ecommerce_sales_table7")) &&
                ((t = $(e).DataTable({
                    info: !1,
                    order: [],
                    pageLength: 10,
                ...
                document.querySelector('[data-kt-ecommerce-order-filter7="search"]').addEventListener("keyup", function (e) {
                    t.search(e.target.value).draw();
                }),
                (() => {
                    const e = document.querySelector('[data-kt-ecommerce-order-filter7="status"]');
                    $(e).on("change", (e) => {
