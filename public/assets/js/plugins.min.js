...
var bootbox = window.bootbox || function(a, b) {
    ...
    l.dialog = function(c, d, e) {
        ...
        for (var m = d.length; m--; ) {
            ...
            if ("undefined" == typeof d[m].label && "undefined" == typeof d[m]["class"] && "undefined" == typeof d[m].callback) {
                ...
                for (var u in d[m])
                    ...
                    ++s > 1)
                        break;
                1 == s && "function" == typeof d[m][u] && (d[m].label = t,
                d[m].callback = d[m][u])
            }
        ...
        var v = ["<div id='bootbox-modal' class='bootbox modal' tabindex='-1' style='overflow:hidden;'>"];
        if (e.header) {
            var w = "";
            ("undefined" == typeof e.headerCloseButton || e.headerCloseButton) && (w = "<a href='" + h + "' class='close'>&times;</a>"),
        ...
        x.on("keyup.dismiss.modal", function(a) {
        ...
        x.on("click", ".modal-footer a", function(a) {
            var c = b(this).data("handler")
              , e = l[c]
              , f = null;
            ("undefined" == typeof c || "undefined" == typeof d[c].href) && (a.preventDefault(),
            "function" == typeof e && (f = e(a)),
            f !== !1 && x.modal("hide"))
        }),
        b("body").append(x),
        x.modal({
...
;(function(e) {
    e.keyboard = function(b, l) {
        ...
        a.init = function() {
            ...
            a.temp = ["", 0, 0];
            e.each("initialized beforeVisible visible hidden canceled accepted beforeClose".split(" "), function(k, c) {
                e.isFunction(d[c]) && a.$el.bind(c + ".keyboard", d[c])
            });
            d.alwaysOpen && (d.stayOpen = !0);
            e(document).bind(["mousedown", "keyup", "touchstart", "checkkeyboard", ""].join(".keyboard "), function(d) {
                a.opening || (a.escClose(d),
                d.target && e(d.target).hasClass("ui-keyboard-input") && (d = e(d.target).data("keyboard"),
                d === a && d.options.openOn && d.focusOn()))
            });
            a.$el.addClass("ui-keyboard-input " + d.css.input).attr({
                "aria-haspopup": "true",
                role: "textbox"
            });
            (a.$el.is(":disabled") || a.$el.attr("readonly") && !a.$el.hasClass("ui-keyboard-lockedinput")) && a.$el.addClass("ui-keyboard-nokeyboard");
            d.openOn && a.$el.bind(d.openOn + ".keyboard", function() {
                a.focusOn()
            });
        ...
        a.focusOn = function() {
            ...
            a.isVisible() || (clearTimeout(a.timer),
            a.reveal());
        ...
        a.reveal = function() {
            ...
            if (a.$el.is(":disabled") || a.$el.attr("readonly") && !a.$el.hasClass("ui-keyboard-lockedinput"))
                a.$el.addClass("ui-keyboard-nokeyboard");
            else
                return a.$el.removeClass("ui-keyboard-nokeyboard"),
                d.openOn && a.$el.unbind(d.openOn + ".keyboard"),
                a.$keyboard && (!a.$keyboard || a.$keyboard.length && !e.contains(document.body, a.$keyboard[0])) || a.startup(),
                a.watermark || a.el.value !== a.inPlaceholder || a.$el.removeClass("ui-keyboard-placeholder").val(""),
                a.originalContent = a.$el.val(),
                a.$preview.val(a.originalContent),
                d.acceptValid && a.checkValid(),
                d.resetDefault && (a.shiftActive = a.altActive = a.metaActive = !1,
                a.showKeySet()),
                d.appendLocally || "body" !== d.appendTo || a.$keyboard.css({
                    position: "absolute",
                    left: 0,
                    top: 0
                }),
                a.$el.trigger("beforeVisible.keyboard", [a, a.el]),
                a.setCurrent(),
                a.$keyboard.show(),
                d.usePreview && a.msie && ("undefined" === typeof a.width && (a.$preview.hide(),
                a.width = Math.ceil(a.$keyboard.width()),
                a.$preview.show()),
                a.$preview.width(a.width)),
                a.position = d.position,
                e.ui && e.ui.position && !e.isEmptyObject(a.position) && (a.position.of = a.position.of || a.$el.data("keyboardPosition") || a.$el,
                a.position.collision = a.position.collision || "flipfit flipfit",
                a.$keyboard.position(a.position)),
                a.checkDecimal(),
                a.lineHeight = parseInt(a.$preview.css("lineHeight"), 10) || parseInt(a.$preview.css("font-size"), 10) + 4,
                d.caretToEnd && (k = a.originalContent.length,
                a.lastCaret = {
                    start: k,
                    end: k
                }),
                a.allie && (k = a.lastCaret.start || a.originalContent.length,
                k = {
                    start: k,
                    end: k
                },
                a.lastCaret || (a.lastCaret = k),
                0 === a.lastCaret.end && 0 < a.lastCaret.start && (a.lastCaret.end = a.lastCaret.start),
                0 > a.lastCaret.start && (a.lastCaret = k)),
                setTimeout(function() {
                    a.opening = !1;
        ...
        ;
        a.startup = function() {
            a.$keyboard && a.$keyboard.length || ("custom" === d.layout && (d.layoutHash = "custom" + a.customHash()),
            a.layout = "custom" === d.layout ? d.layoutHash : d.layout,
            "undefined" === typeof e.keyboard.builtLayouts[a.layout] && (e.isFunction(d.create) && d.create(a),
            a.$keyboard.length || a.buildKeyboard()),
            a.$keyboard = e.keyboard.builtLayouts[a.layout].$keyboard.clone(),
            d.usePreview ? (a.$preview = a.$el.clone(!1).removeAttr("id").removeClass("ui-keyboard-placeholder ui-keyboard-input").addClass("ui-keyboard-preview " + d.css.input).removeAttr("aria-haspopup").attr("tabindex", "-1").show(),
            "number" == a.$preview.attr("type") && a.$preview.attr("type", "text"),
            e("<div />").addClass("ui-keyboard-preview-wrapper").append(a.$preview).prependTo(a.$keyboard)) : (a.$preview = a.$el,
            e.isEmptyObject(a.position) || (d.position.at = d.position.at2)));
            ...
            d.lockInput && a.$preview.addClass("ui-keyboard-lockedinput").attr({
                readonly: "readonly"
            });
            a.bindKeyboard();
            a.$keyboard.appendTo(d.appendLocally ? a.$el.parent() : d.appendTo || "body");
            a.bindKeys();
            e.ui && e.ui.position && !e.isEmptyObject(a.position) && e(window).bind("resize.keyboard", function() {
        ...
        a.bindKeyboard = function() {
            ...
            a.$preview.unbind("keypress keyup keydown mouseup touchend ".split(" ").join(".keyboard ")).bind("keypress.keyboard", function(c) {
                ...
                if (d.restrictInput) {
                    if ((8 === c.which || 0 === c.which) && e.inArray(c.keyCode, a.alwaysAllowed))
                        return;
                    -1 === e.inArray(g, k.acceptedKeys) && c.preventDefault()
                } else if ((c.ctrlKey || c.metaKey) && (97 === c.which || 99 === c.which || 118 === c.which || 120 <= c.which && 122 >= c.which))
                    return;
                k.hasMappedKeys && k.mappedKeys.hasOwnProperty(g) && (a.lastKey = k.mappedKeys[g],
                a.insertText(a.lastKey),
                c.preventDefault());
                a.checkMaxLength()
            }).bind("keyup.keyboard", function(c) {
                switch (c.which) {
                case 9:
                    if (a.tab && d.tabNavigation && !d.lockInput) {
                        if (a.shiftActive = c.shiftKey,
                        c = e.keyboard.keyaction.tab(a),
                        a.tab = !1,
                        !c)
                            return !1
                    } else
                ...
                a.throttled = setTimeout(function() {
            ...
            a.$keyboard.bind("mousedown.keyboard click.keyboard touchstart.keyboard", function(c) {
                c.stopPropagation();
                a.isCurrent() || (a.reveal(),
                e(document).trigger("checkkeyboard.keyboard"))
            });
            d.preventPaste && (a.$preview.bind("contextmenu.keyboard", function(a) {
                a.preventDefault()
            }),
            a.$el.bind("contextmenu.keyboard", function(a) {
                a.preventDefault()
            }))
        }
        ;
        a.bindKeys = function() {
            ...
            a.$allKeys = a.$keyboard.find("button.ui-keyboard-button").unbind(k).bind(d.keyBinding.split(" ").join(".keyboard ") + ".keyboard repeater.keyboard", function(c) {
                ...
                if (!(b - (a.lastEventTime || 0) < d.preventDoubleEventTime)) {
                    ...
                    k.match("meta") && (k = "meta");
                    if (e.keyboard.keyaction.hasOwnProperty(k) && e(this).hasClass("ui-keyboard-actionkey")) {
                        if (!1 === e.keyboard.keyaction[k](a, this, c))
                            return !1
                    } else
                        "undefined" !== typeof k && (g = a.lastKey = a.wheel && !e(this).hasClass("ui-keyboard-actionkey") ? a.lastKey : k,
                        a.insertText(g),
                        a.capsLock || d.stickyShift || c.shiftKey || (a.shiftActive = !1,
                        a.showKeySet(this)));
                ...
                if (a.isCurrent()) {
                    ...
                    k.data("layers", b = e.grep(b, function(a, c) {
                        return e.inArray(a, b) === c
                    }));
                    "mouseenter" !== c.type && "touchstart" !== c.type || "password" === a.el.type || k.hasClass(d.css.buttonDisabled) || k.addClass(d.css.buttonHover).attr("title", function(k, e) {
                        return a.wheel && "" === e && a.sets && 1 < b.length && "touchstart" !== c.type ? d.wheelMessage : e
                    });
                    "mouseleave" === c.type && (k.data({
                        curtxt: k.data("original"),
                        curnum: 0
                    }),
                    k.removeClass("password" === a.el.type ? "" : d.css.buttonHover).attr("title", function(a, c) {
                        return c === d.wheelMessage ? "" : c
                    }).find("span").html(k.data("original")))
                }
                ...
                if (a.wheel) {
                    ...
                    1 < b.length ? (k = f.data("curnum") + (0 < d ? -1 : 1),
                    k > b.length - 1 && (k = 0),
                    0 > k && (k = b.length - 1)) : k = 0;
                    f.data({
                        curnum: k,
                        layers: b,
                        curtxt: b[k]
                ...
                /(mouseleave|touchend|touchcancel)/.test(c.type) ? e(this).removeClass(d.css.buttonHover) : (a.isVisible() && a.isCurrent() && a.$preview.focus(),
                a.checkCaret && a.$preview.caret(a.lastCaret));
                a.mouseRepeat = [!1, ""];
                ...
                if (0 !== d.repeatRate) {
                    ...
                    a.mouseRepeat = [!0, c];
                    setTimeout(function() {
                        a.mouseRepeat[0] && a.mouseRepeat[1] === c && a.repeatKey(c)
                    }, d.repeatDelay)
                }
                return !1
            })
        ...
        a.insertText = function(d) {
            ...
            a.el.dispatchEvent(changeEvent);
            const keyupEvent = new Event('keyup', { bubbles: true });
        a.el.dispatchEvent(keyupEvent);
        const inputEvent = new Event('input', { bubbles: true });
        a.el.dispatchEvent(inputEvent);
            var c, b;
            b = a.$preview.val();
            ...
            "TEXTAREA" === a.preview.tagName && (a.msie && "\n" === b.substr(e.start, 1) && (e.start += 1,
            e.end += 1),
            b = b.split("\n").length - 1,
            a.preview.scrollTop = 0 < b ? a.lineHeight * b : c);
        ...
        a.checkMaxLength = function() {
            ...
            !1 !== d.maxLength && c.length > d.maxLength && (k = Math.min(a.$preview.caret().start, d.maxLength),
        ...
        a.repeatKey = function(d) {
            ...
            a.mouseRepeat[0] && (a.repeater = setTimeout(function() {
                a.repeatKey(d)
            }, a.repeatTime))
        }
        ;
        a.showKeySet = function(b) {
            ...
            if (a.metaActive) {
                if (c = b && b.name && /meta/.test(b.name) ? b.name : "",
                "" === c ? c = !0 === a.metaActive ? "" : a.metaActive : a.metaActive = c,
                !d.stickyShift && a.lastKeyset[2] !== a.metaActive || (a.shiftActive || a.altActive) && !a.$keyboard.find(".ui-keyboard-keyset-" + c + a.rows[e]).length)
                    a.shiftActive = a.altActive = !1
            } else
                !d.stickyShift && a.lastKeyset[2] !== a.metaActive && a.shiftActive && (a.shiftActive = a.altActive = !1);
            e = (a.shiftActive ? 1 : 0) + (a.altActive ? 2 : 0);
            c = 0 !== e || a.metaActive ? "" === c ? "" : "-" + c : "-default";
            a.$keyboard.find(".ui-keyboard-keyset" + c + a.rows[e]).length ? (a.$keyboard.find(".ui-keyboard-alt, .ui-keyboard-shift, .ui-keyboard-actionkey[class*=meta]").removeClass(d.css.buttonAction).end().find(".ui-keyboard-alt")[a.altActive ? "addClass" : "removeClass"](d.css.buttonAction).end().find(".ui-keyboard-shift")[a.shiftActive ? "addClass" : "removeClass"](d.css.buttonAction).end().find(".ui-keyboard-lock")[a.capsLock ? "addClass" : "removeClass"](d.css.buttonAction).end().find(".ui-keyboard-keyset").hide().end().find(".ui-keyboard-keyset" + c + a.rows[e]).show().end().find(".ui-keyboard-actionkey.ui-keyboard" + c).addClass(d.css.buttonAction),
            a.lastKeyset = [a.shiftActive, a.altActive, a.metaActive]) : (a.shiftActive = a.lastKeyset[0],
            a.altActive = a.lastKeyset[1],
            a.metaActive = a.lastKeyset[2])
        }
        ;
        a.checkCombos = function() {
            if (!a.isVisible())
                return a.$preview.val();
            var b, c, g, n, h = a.$preview.val(), f = a.$preview.caret(), l = e.keyboard.builtLayouts[a.layout], p = h.length;
            f.end < f.start && (f.end = f.start);
            f.start > p && (f.end = f.start = p);
            a.msie && "\n" === h.substr(f.start, 1) && (f.start += 1,
            f.end += 1);
            d.useCombos && (a.msie ? h = h.replace(a.regex, function(a, c, b) {
                return d.combos.hasOwnProperty(c) ? d.combos[c][b] || a : a
            }) : a.$preview.length && (g = f.start - (0 <= f.start - 2 ? 2 : 0),
            a.$preview.caret(g, f.end),
            n = (a.$preview.caret().text || "").replace(a.regex, function(a, c, b) {
                return d.combos.hasOwnProperty(c) ? d.combos[c][b] || a : a
            }),
            a.$preview.val(a.$preview.caret().replace(n)),
            h = a.$preview.val()));
            if (d.restrictInput && "" !== h) {
                g = h;
                c = l.acceptedKeys.length;
                for (b = 0; b < c; b++)
                    "" !== g && (n = l.acceptedKeys[b],
                    0 <= h.indexOf(n) && (/[\[|\]|\\|\^|\$|\.|\||\?|\*|\+|\(|\)|\{|\}]/g.test(n) && (n = "\\" + n),
                    g = g.replace(new RegExp(n,"g"), "")));
                "" !== g && (h = h.replace(g, ""))
            }
            f.start += h.length - p;
            f.end += h.length - p;
        ...
        a.checkDecimal = function() {
            a.decimal && /\./g.test(a.preview.value) || !a.decimal && /\,/g.test(a.preview.value) ? a.$decBtn.attr({
                disabled: "disabled",
                "aria-disabled": "true"
            }).removeClass(d.css.buttonDefault + " " + d.css.buttonHover).addClass(d.css.buttonDisabled) : a.$decBtn.removeAttr("disabled").attr({
                "aria-disabled": "false"
            }).addClass(d.css.buttonDefault).removeClass(d.css.buttonDisabled)
        }
        ;
        a.getLayers = function(a) {
            var c;
            c = a.attr("data-pos");
            return a.closest(".ui-keyboard").find('button[data-pos="' + c + '"]').map(function() {
                return e(this).find("> span").html()
            }).get()
        }
        ;
        a.switchInput = function(b, c) {
            if ("function" === typeof d.switchInput)
                d.switchInput(a, b, c);
            else {
                a.$keyboard.hide();
                var g;
        ...
        a.close = function(b) {
            if (a.isOpen) {
                ...
                if (b && d.validate && "function" === typeof d.validate && !d.validate(a, c, !0) && (c = a.originalContent,
                b = !1,
                d.cancelClose))
                    return;
                a.isCurrent(!1);
                ...
                d.openOn && (a.timer = setTimeout(function() {
                    a.$el.bind(d.openOn + ".keyboard", function() {
                        a.focusOn()
                    });
                    e(":focus")[0] === a.el && a.$el.blur()
                }, 500));
                !d.alwaysOpen && a.$keyboard && (a.$keyboard.remove(),
                a.$keyboard = []);
        ...
        a.escClose = function(b) {
            if (b && "keyup" === b.type)
                return 27 === b.which ? a.close() : "";
            a.isOpen && (!a.isCurrent() && a.isOpen || a.isOpen && b.target !== a.el && !d.stayOpen) && (a.allie && b.preventDefault(),
            a.close(d.autoAccept ? "true" : !1))
        }
        ;
        ...
        a.addKey = function(b, c, g) {
            ...
            c = h,
            f = h.split(":"),
            h = "" !== f[0] && 1 < f.length ? f[0] : h,
            e.keyboard.builtLayouts[a.layout].mappedKeys[l] = h);
            f = c.split(":");
            "" === f[0] && "" === f[1] && (c = ":");
            ...
            return a.keyBtn.clone().attr({
                ...
                "data-curtxt": c,
                "data-curnum": 0
            }).addClass(("" === m ? "" : "ui-keyboard-" + m + h + " ") + d.css.buttonDefault).html("<span>" + c + "</span>").appendTo(a.temp[0])
        }
        ;
        ...
        a.buildKeyboard = function() {
            var b, c, g, l, h, f, m, p, q, s = 0, r = e.keyboard.builtLayouts[a.layout] = {
                mappedKeys: {},
                acceptedKeys: []
            }, t = r.acceptedKeys = [], u = e("<div />").addClass("ui-keyboard " + d.css.container + (d.alwaysOpen ? " ui-keyboard-always-open" : "")).attr({
                role: "textbox"
            }).hide();
            "custom" !== d.layout && e.keyboard.layouts.hasOwnProperty(d.layout) || (d.layout = "custom",
            e.keyboard.layouts.custom = d.customLayout || {
                "default": ["{cancel}"]
            });
            e.each(e.keyboard.layouts[d.layout], function(r, v) {
                if ("" !== r)
                    for (s++,
                    l = e("<div />").attr("name", r).addClass("ui-keyboard-keyset ui-keyboard-keyset-" + r).appendTo(u)["default" === r ? "show" : "hide"](),
                    g = 0; g < v.length; g++) {
                        ...
                        for (m = 0; m < p.length; m++)
                            ...
                            0 !== p[m].length)
                                if (/^\{\S+\}$/.test(p[m]))
                                    if (c = p[m].match(/^\{(\S+)\}$/)[1].toLowerCase(),
                                    /\!\!/.test(c) && (c = c.replace("!!", ""),
                                    h = !0),
                                    /^sp:((\d+)?([\.|,]\d+)?)(em|px)?$/.test(c) && (q = parseFloat(c.replace(/,/, ".").match(/^sp:((\d+)?([\.|,]\d+)?)(em|px)?$/)[1] || 0),
                                    e("<span>&nbsp;</span>").width(c.match("px") ? q + "px" : 2 * q + "em").addClass("ui-keyboard-button ui-keyboard-spacer").appendTo(l)),
                                    /^empty(:((\d+)?([\.|,]\d+)?)(em|px)?)?$/.test(c) && (q = /:/.test(c) ? parseFloat(c.replace(/,/, ".").match(/^empty:((\d+)?([\.|,]\d+)?)(em|px)?$/)[1] || 0) : "",
                                    a.addKey("", " ").addClass(d.css.buttonDisabled + " " + d.css.buttonEmpty).attr("aria-disabled", !0).width(q ? c.match("px") ? q + "px" : 2 * q + "em" : "")),
                                    /^meta\d+\:?(\w+)?/.test(c))
                                        a.addKey(c, c);
                                    else
                                        switch (c) {
                                        ...
                                        case "tab":
                                            ...
                                            break;
                                        default:
                                            if (e.keyboard.keyaction.hasOwnProperty(c))
                                                a.addKey(c, c)[h ? "addClass" : "removeClass"](d.css.buttonAction)
                                        }
                                else
                                    b = p[m],
                                    t.push(":" === b ? b : b.split(":")[0]),
                                    a.addKey(b, b, !0);
    ...
    e.keyboard.keyaction = {
        ...
        dec: function(b) {
            b.insertText(b.decimal ? "." : ",")
        },
        "default": function(b, e) {
            b.shiftActive = b.altActive = b.metaActive = !1;
            b.showKeySet(e)
        },
        enter: function(b, l, a) {
            l = b.el.tagName;
            var d = b.options;
            if (a.shiftKey)
                return d.enterNavigation ? b.switchInput(!a[d.enterMod], !0) : b.close(!0);
            if (d.enterNavigation && ("TEXTAREA" !== l || a[d.enterMod]))
                return b.switchInput(!a[d.enterMod], d.autoAccept ? "true" : !1);
            "TEXTAREA" === l && e(a.target).closest("button").length && b.insertText(" \n")
        },
        lock: function(b, e) {
        ...
        next: function(b) {
            b.switchInput(!0, b.options.autoAccept);
            return !1
        },
        prev: function(b) {
            b.switchInput(!1, b.options.autoAccept);
            return !1
        },
        right: function(b) {
            var e = b.$preview.caret();
            e.start + 1 <= b.$preview.val().length && (b.lastCaret = {
                start: e.start + 1,
                end: e.start + 1
            })
        },
        ...
        sign: function(b) {
            /^\-?\d*\.?\d*$/.test(b.$preview.val()) && b.$preview.val(-1 * b.$preview.val())
        },
        space: function(b) {
            b.insertText(" ")
        },
        tab: function(b) {
            var e = b.options;
            if ("INPUT" === b.el.tagName)
                return e.tabNavigation ? b.switchInput(!b.shiftActive, !0) : !1;
            b.insertText("\t")
        }
    };
    ...
    e.keyboard.layouts = {
        ...
        num: {
            "default": "= ( ) {b};{clear} / * -;7 8 9 +;4 5 6 {sign};1 2 3 %;0 . {a} {c}".split(";")
        }
    };
    e.keyboard.defaultOptions = {
        ...
        display: {
            ...
            accept: "Ruaj:Ruaj (Shift-Enter)",
            alt: "Alt:\u2325 AltGr",
            b: "\u232b:Backspace",
            bksp: "Bksp:Backspace",
            c: "\u2716:Cancel (Esc)",
            cancel: "Anulo:Anulo (Esc)",
            clear: "C:Clear",
        ...
        validate: function(b, e, a) {
            return !0
        }
    };
    e.keyboard.comboRegex = /([`\'~\^\"ao])([a-z])/mig;
    e.keyboard.currentKeyboard = "";
    e.fn.keyboard = function(b) {
        return this.each(function() {
            e(this).data("keyboard") || new e.keyboard(this,b)
        })
    }
    ;
...
(function(e, b, l, a) {
    e.fn.caret = function(d, e) {
        if ("undefined" === typeof this[0] || this.is(":hidden") || "hidden" === this.css("visibility"))
            return this;
        var c, g, n, h, f;
        ...
        var m = this[0]
          ...
          , s = !0;
        try {
            q = "undefined" !== typeof m.selectionStart
        } catch (r) {
            s = !1
        }
        "object" === typeof d && d.start && d.end ? (g = d.start,
        h = d.end) : "number" === typeof d && "number" === typeof e && (g = d,
        h = e);
        if (s && "undefined" !== typeof g)
            return q ? (m.selectionStart = g,
            m.selectionEnd = h) : (f = m.createTextRange(),
            f.collapse(!0),
            f.moveStart("character", g),
            f.moveEnd("character", h - g),
            f.select()),
            (this.is(":visible") || "hidden" !== this.css("visibility")) && this.focus(),
            m.scrollTop = p,
            this;
        q ? (c = m.selectionStart,
        n = m.selectionEnd) : f ? "TEXTAREA" === m.tagName ? (h = this.val(),
        g = f[l](),
        f = g[a](),
        f.moveToElementText(m),
        f.setEndPoint("EndToEnd", g),
        c = f.text.replace(/\r/g, "\n")[b],
        n = c + g.text.replace(/\r/g, "\n")[b]) : (h = this.val().replace(/\r/g, "\n"),
        g = f[l]()[a](),
        g.moveEnd("character", h[b]),
        c = "" === g.text ? h[b] : h.lastIndexOf(g.text),
        g = f[l]()[a](),
        g.moveStart("character", -h[b]),
        n = g.text[b]) : (c = 0,
        n = (m.value || "").length);
        ...
        return {
            ...
            text: f,
            replace: function(a) {
                return m.value.substring(0, c) + a + m.value.substring(n, m.value[b])
            }
        }
    }
}
...
shortcut = {
    ...
    add: function(e, t, a) {
        ...
        var o = function(r) {
            ...
            a.disable_in_input) {
                var n;
                if (r.target ? n = r.target : r.srcElement && (n = r.srcElement),
            ...
            i < o.length; i++)
                "ctrl" == k || "control" == k ? (d++,
                p.ctrl.wanted = !0) : "shift" == k ? (d++,
                p.shift.wanted = !0) : "alt" == k ? (d++,
                p.alt.wanted = !0) : "meta" == k ? (d++,
                p.meta.wanted = !0) : k.length > 1 ? l[k] == code && d++ : a.keycode ? a.keycode == code && d++ : s == k ? d++ : c[s] && r.shiftKey && (s = c[s],
                s == k && d++);
            return d != o.length || p.ctrl.pressed != p.ctrl.wanted || p.shift.pressed != p.shift.wanted || p.alt.pressed != p.alt.wanted || p.meta.pressed != p.meta.wanted || (t(r),
            a.propagate) ? void 0 : (r.cancelBubble = !0,
            r.returnValue = !1,
...
!function(a, b) {
    ...
    function c(c, g) {
        ...
        ,
        h.destroy = function() {
            h.$el.unbind("destroyed", h.teardown),
            h.teardown()
        }
        ,
        h.teardown = function() {
        ...
        h.bind = function() {
            ...
            h.isWindowScrolling || (h.$window.on("scroll." + d + h.id, h.setPositionValues),
        ...
        h.unbind = function() {
            ...
            h.isWindowScrolling || (h.$window.off("." + d + h.id, h.setPositionValues),
        ...
        h.toggleHeaders = h.debounce(function() {
            h.$el && h.$el.each(function() {
                ...
                k && l ? (b = f.left - i + h.options.leftOffset,
                ...
                h.isSticky || (h.isSticky = !0,
                h.updateWidth(),
                c.trigger("enabledStickiness." + d)),
                h.setPositionValues()) : h.isSticky && (h.$originalHeader.css("position", "static"),
